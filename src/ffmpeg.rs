...
///
/// The spawned child process uses `kill_on_drop(true)`. When the owning async
/// task is aborted or dropped, Tokio terminates the FFmpeg process instead of
/// leaving an orphan process running in the background.
